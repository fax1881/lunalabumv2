...
const EBATLAR = ['30x40 cm', '40x60 cm', '50x70 cm', '60x80 cm', '80x120 cm'];

export default function CanvasSiparis() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-6 text-center">Canvas Tablo Sipariş Formu</h1>
