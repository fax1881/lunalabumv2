...
export default function EditProductPage() {
  ...
  const fetchProduct = async () => {
    try {
      ...
      const mockProduct: ProductForm = {
        ...
        description: 'Yüksek kaliteli fotoğraf baskısı hizmeti. Profesyonel kağıt ve mürekkep kullanarak en iyi sonucu alın.',
        price: 12.50,
        category: 'Fotoğraf Baskısı',
        image: '/images/photo-print.jpg',
        isActive: true,
        sizes: ['A4', 'A3', '10x15', '13x18'],
        features: ['Yüksek kaliteli baskı', 'Hızlı teslimat', 'UV korumalı']
      };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Güncellenen ürün:', form);
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Ürün Düzenle</h1>
