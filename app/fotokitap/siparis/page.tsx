...
const EBATLAR = ['A4 (20 sayfa)', 'A4 (40 sayfa)', 'A4 (60 sayfa)'];

export default function FotokitapSiparis() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-4">
      <h1 className="text-3xl font-bold mb-6 text-center">Fotokitap Sipariş Formu</h1>
