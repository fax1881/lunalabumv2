...
const PolaCanvas = () => {
  const products = [
    {
      id: 1,
      name: '9x11 cm Pola Canvas',
      description: 'Küçük boyut pola canvas',
      price: '25₺',
      features: ['Pola tasarım', 'Yüksek kalite', 'Retro görünüm'],
      image: '/images/pola-canvas-9x11.jpg'
    },
    {
      id: 2,
      name: '6x9 cm Pola Canvas',
      description: 'Orta boyut pola canvas',
      price: '20₺',
      features: ['Retro tasarım', 'Dayanıklı', 'Şık görünüm'],
      image: '/images/pola-canvas-6x9.jpg'
    },
    {
      id: 3,
      name: '9x9 cm Pola Canvas',
      description: 'Kare boyut pola canvas',
      price: '22₺',
      features: ['Kare format', 'Profesyonel', 'Kaliteli'],
      image: '/images/pola-canvas-9x9.jpg'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-cyan-600 to-cyan-700 text-white py-20">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl lg:text-2xl mb-8 text-cyan-100">
              Retro polaroid canvas tasarımı
            </p>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-cyan-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <feature.icon className="text-cyan-600 text-2xl" />
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-light mb-4">
              Pola Canvas Boyutları
            </h2>
            <p className="text-gray-600 text-lg">
              İhtiyacınıza uygun pola canvas boyutunu seçin
            </p>
          </motion.div>
            ...
            {products.map((product, index) => (
              ...
              >
                <div className="h-48 bg-gradient-to-br from-cyan-100 to-cyan-200 flex items-center justify-center">
                  <FileImage className="text-cyan-600 text-4xl" />
                </div>
                <div className="p-6">
                  ...
                  <button className="w-full bg-cyan-600 hover:bg-cyan-700 text-white py-3 px-4 rounded-lg transition-colors font-medium">
                    Sipariş Ver
                  </button>
                </div>
              </motion.div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-light mb-4">
              Pola Canvasınızı Hemen Basın
            </h2>
            <p className="text-xl mb-8 text-primary-100">
              Retro polaroid canvas için hemen sipariş verin
            </p>
